  ...
  if (selectedOrg) {
    return (
      <div className='max-w-lg mx-auto px-4 py-8'>
        <h1 className='text-2xl font-bold text-text mb-6'>Create Subaccount</h1>
        <div className='card p-2'>
          <p className='text-text/70 mb-6'>
            Organizer approved! Now create their Paystack subaccount to enable
            payouts.
          </p>
    ...
    <div className='max-w-4xl mx-auto px-4 py-8'>
      ...
      {organizers.length === 0 ? (
        <div className='card p-12 text-center'>
          ...
          <h3 className='text-xl font-semibold text-text'>All caught up!</h3>
          <p className='text-text/50 mt-2'>No pending organizer approvals</p>
        </div>
      ) : (
        <div className='space-y-4'>
          {organizers.map((org) => (
            <div key={org._id} className='card p-2'>
              <div className='flex items-start justify-between'>
                <div>
                  <h3 className='font-semibold text-text'>{org.fullName}</h3>
                  <p className='text-text/50 text-sm'>{org.email}</p>
