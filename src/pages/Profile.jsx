    ...
    <div className='max-w-2xl mx-auto px-4 py-8'>
      <div className='card'>
        <div className='p-6 border-b border-text/10'>
          <h1 className='text-xl font-bold text-text/90 flex items-center gap-2'>
            <HiUser className='text-text/60' />
            My Profile
          </h1>
        ...
        <form onSubmit={handleSubmit} className='p-6 space-y-5'>
          {error && (
            <div className='p-4 bg-red-50 border border-red-200 text-text/90 flex items-center gap-3'>
          ...
          {success && (
            <div className='p-4 bg-green-50 border border-green-200 text-text/90 flex items-center gap-3'>
          ...
          <div>
            ...
            <div className='relative'>
              <HiUser className='absolute left-3 top-1/2 -translate-y-1/2 text-text/50' />
              <input
                type='text'
                name='fullName'
          ...
          <div>
            ...
            <div className='relative'>
              <HiPhone className='absolute left-3 top-1/2 -translate-y-1/2 text-text/50' />
              <input
                type='tel'
                name='phone'
          ...
          {user?.role === "organizer" && (
            <>
              <hr className='my-6 text-text/70' />
              <h3 className='font-semibold text-text/80'>Organizer Details</h3>
          ...
          <hr className='my-6 text-text/70' />
          <h3 className='font-semibold text-text/80'>Change Password</h3>
          ...
          <div>
            ...
            <div className='relative'>
              <HiLockClosed className='absolute left-3 top-1/2 -translate-y-1/2 text-text/50' />
              <input
                type='password'
                name='password'
