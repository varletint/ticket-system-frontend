    ...
    return (
      <div className='max-w-xl mx-auto px-4 py-8'>
        <div className='card p-8 text-center'>
          ...
          <h1 className='text-xl font-bold text-text/90 mb-2'>
            Payout Already Setup
          </h1>
    ...
    return (
      <div className='max-w-xl mx-auto px-4 py-8'>
        <div className='card p-8 text-center'>
          ...
          <p className='text-text/70'>Redirecting to dashboard...</p>
        </div>
      </div>
    );
  }
        ...
        <form onSubmit={handleSubmit} className='p-6 space-y-5'>
          ...
          <div>
            ...
            <div className='relative'>
              <HiBuildingOffice className='absolute left-3 top-1/2 -translate-y-1/2 text-text/70' />
              <input
                type='text'
                name='businessName'
