...
import { HiCalendar, HiLocationMarker, HiClock, HiTicket, HiMinus, HiPlus } from 'react-icons/hi';
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="relative h-64 md:h-96 rounded-2xl overflow-hidden mb-8">
                ...
                <div className="absolute bottom-6 left-6 text-white">
                    ...
                    {event.artist && <p className="text-xl opacity-90 mt-1">{event.artist}</p>}
                </div>
            </div>
                ...
                <div className="md:col-span-2 space-y-6">
                    ...
                    <div className="card p-6">
                        <div className="grid sm:grid-cols-2 gap-4">
                            ...
                            <div className="flex items-start gap-3">
                                <div className="p-3 bg-primary-50 rounded-lg">
                                    <HiLocationMarker className="text-xl text-primary-600" />
                                </div>
                                <div>
                                    ...
                                    >
                                        <div className="flex justify-between items-start">
                                            ...
                                            <div className="text-right">
                                                <p className="font-bold text-gray-900">₦{tier.price.toLocaleString()}</p>
                                                <p className={`text-xs ${available < 10 ? 'text-red-500' : 'text-gray-500'}`}>
                        ...
                        {selectedTier && (
                            <div className="mb-6">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <button
                                        onClick={() => setQuantity(Math.min(selectedTier.maxPerUser || 4, quantity + 1))}
                                        className="p-2 rounded-lg border border-gray-200 hover:bg-gray-50"
                                    >
                                        <HiPlus />
                                    </button>
