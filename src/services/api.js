...
export const adminAPI = {
    ...
    createSubaccount: (id, data) => api.post(`/admin/organizers/${id}/create-subaccount`, data),
    getBanks: () => api.get('/admin/banks'),
    assignValidator: (userId, eventId) => api.post(`/admin/validators/${userId}/assign`, { eventId })
};
